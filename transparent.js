    ...
    function replacePlaylistIcons() {
      ...
      for (const item of playListItems) {
        ...
        if (link.search("playlist") !== -1) {
          ...
          item.style.WebkitMaskImage = "url('https://cdn.jsdelivr.net/gh/sandarutharuneth/spicetify-transparent@master/assets/fluentui-system-icons/ic_fluent_folder_24_filled.svg')"
          continue;
        }
        ...
        Spicetify.CosmosAsync.get(
          ...
          if (meta.picture === "") {
            item.style.backgroundImage = "url('https://cdn.jsdelivr.net/gh/sandarutharuneth/spicetify-transparent@master/assets/fluentui-system-icons/ic_fluent_music_note_2_24_filled.svg')"
          } else {
  ...
  var interval = setInterval(function () {
    ...
    playButtonStyle.innerHTML = `
      ...
      .main-trackList-rowPlayPauseButton[aria-label="${Spicetify.Platform.Translations.play}"] {
        ...
        -webkit-mask-image: url('https://cdn.jsdelivr.net/gh/sandarutharuneth/spicetify-transparent@master/assets/fluentui-system-icons/ic_fluent_play_24_filled.svg') !important;
      }
      ...
      .main-trackList-rowPlayPauseButton[aria-label="${Spicetify.Platform.Translations.pause}"] {
        background-color: var(--spice-text) !important;
        -webkit-mask-image: url('https://cdn.jsdelivr.net/gh/sandarutharuneth/spicetify-transparent@master/assets/fluentui-system-icons/ic_fluent_pause_16_filled.svg') !important;
      }`;
